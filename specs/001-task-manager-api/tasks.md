...
- [X] T006 [P] Create [scripts/assert-azure-context.sh](../../scripts/assert-azure-context.sh) that fails fast if `az account show --query id -o tsv` ≠ `$AZURE_SUBSCRIPTION_ID` or if the target RG argument ≠ `$AZURE_RESOURCE_GROUP`; make executable
